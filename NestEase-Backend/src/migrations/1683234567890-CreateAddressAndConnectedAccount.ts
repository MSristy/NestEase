...
export class CreateAddressAndConnectedAccount1683234567890 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        const addressForeignKey = addressTable.foreignKeys.find(
        ...
        const connectedAccountForeignKey = connectedAccountTable.foreignKeys.find(
            (fk) => fk.columnNames.indexOf('userId') !== -1,
        );
