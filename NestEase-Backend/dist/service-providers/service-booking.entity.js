...
__decorate([
    (0, typeorm_1.ManyToOne)(() => service_provider_entity_1.ServiceProvider, provider => provider.bookings),
    __metadata("design:type", service_provider_entity_1.ServiceProvider)
], ServiceBooking.prototype, "serviceProvider", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, user => user.serviceBookings),
